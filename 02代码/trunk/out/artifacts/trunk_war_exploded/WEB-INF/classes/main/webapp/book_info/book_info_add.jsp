            ...
            <form class="layui-form" action="" lay-filter="example">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input id="title" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="输入书名" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">作者：</label>
                    <div class="layui-input-block">
                        <input id="author" type="text" name="author" lay-verify="title" autocomplete="off" placeholder="输入作者" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">isbn：</label>
                    <div class="layui-input-block">
                        <input id="isbn"type="text" name="isbn" lay-verify="title" autocomplete="off" placeholder="输入isbn" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">出版社：</label>
                    <div class="layui-input-block">
                        <input id="publish" type="text" name="publish" lay-verify="title" autocomplete="off" placeholder="输入出版社" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button id="book_info_add" type="button" class="layui-btn" lay-submit="" lay-filter="demo1" onclick="bookInfoAdd()">添加</button>
                    </div>
                </div>
            </form>
        </div>
...
<script src="book_info_add.js"></script>
<script>
    //JavaScript代码区域
