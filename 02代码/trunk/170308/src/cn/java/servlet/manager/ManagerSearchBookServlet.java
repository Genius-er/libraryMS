...
@WebServlet("/ManagerSearchBookServlet")
public class ManagerSearchBookServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            List<Map<String, Object>> books = manager.searchBook(name, request);
